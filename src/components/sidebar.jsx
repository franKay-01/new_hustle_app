        ...
        <nav className="flex flex-col space-y-2 px-4 text-left">
          { Cookies.get('token') ?
            <>
              ...
              <Link onClick={handleLogout} className={`flex flex-row gap-2 text-black py-2 px-4 rounded text-left items-center`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="size-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
                </svg>
                <h1 className="sidebar-label">Logout</h1>
              </Link>
            </>:
            <Link to={'/auth'} className={`flex flex-row gap-2 text-black py-2 rounded text-left items-center`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75" />
              </svg>
              <h1 className="sidebar-label">Login</h1>
            </Link>
          }
        </nav>
      </aside>
