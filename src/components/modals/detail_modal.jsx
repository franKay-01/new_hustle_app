...
export default function HustleDetailModal({handleClose, show, handleShowProposalModal}) {
              ...
              <Popover.Panel className="absolute right-0 top-7 z-10 mt-8 dropdown-margin">
                <div className='flex flex-col menu-bar menu-bar-alt'>
                  <>
                    ...
                    <div onClick={() => handleShowProposalModal()} className="flex flex-row gap-2 items-center mt-4 cursor-pointer">
                    ...
                    <div onClick={() => submitProposal()} className="flex flex-row gap-2 items-center mt-4 cursor-pointer">
                      <svg className="w-5 h-5" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_7344_123340)">
                        <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20Z" fill="#575757"/>
                        </g>
