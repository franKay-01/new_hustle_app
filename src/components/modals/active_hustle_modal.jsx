...
export default function ActiveHustleDetailModal({handleClose, show, statusMessage, confirmHustle, activeHustleDetails}) {
          ...
          <div className="flex flex-row gap-2 justify-between items-center">
            { activeKey === 'progress' ?
              <>
                ...
                <button onClick={() => {confirmHustle(); handleClose()}} className='hidden lg:flex md:flex modal-more-button justify-center items-center'>
                ...
                <div className="flex flex-col mt-4">
                  ...
                  <div className="flex flex-row items-center">
                    <h1 className="view-more-header">
                      GHS {activeHustleDetails.my_bid.amount}
                    </h1>/
                  ...
                  <div className="flex flex-row gap-8 mt-4">
                    ...
                    <div className="flex flex-col">
                      <h1 className="info-card-time info-card-time-alt">Preferred date</h1>
                      <h1 className="info-card-text-color">{activeHustleDetails.my_bid.proposed_date} </h1>
                    </div>
                  </div>
                </div>
              </>
