...
export default function HomePage(){
  ...
  const { retrieveAllHustles, getTopHustlers, createProposal, retrieveAllServices } = useHustleFunctions()
  ...
  const selectHustle = (selected, alt) => {
    if (alt === true){
      getHustleDetails(selected.hustler.hustler_uuid)
                      ...
                      { allHustles.map((item, index) => {
                        return <div key={index} className="info-card info-card-alt">
                          ...
                          <div className="px-4 py-2">
                            ...
                            <button onClick={() => selectHustle(item, false)} className='flex view-more-button justify-center items-center mt-4'>
