              ...
              <div className="info-card p-3">
                <div className="flex flex-row justify-between">
                  ...
                  <div className="flex flex-row items-start">
                    ...
                    <h1 className="info-card-desc !text-[13.5px]">4.6 (10)</h1>
                  </div>
                </div>
                <div className="p-1 flex flex-col gap-2 mt-4">
                  <h1 className="view-more-header info-card-ellipsis !text-[16px]">Plumber needed for a bathroom fix for quick gigs</h1>
                  <img src={CreatorImg} className="h-28 rounded-md mt-2"/>
                  <h1 className="info-card-desc line-clamp-2">
                    Looking for a skilled plumber to fix a leaking bathroom sink and check the bathroom pipes for any blockages. Should be reliable, fast, and have basic tools. Estimated Duration should be 1–2 hours. I’m available on weekends
                  </h1>
                </div>
                <button onClick={() => setShowHustlerDetailModal(true)} className='flex view-more-button view-more-button-alt justify-center items-center mt-4'>
